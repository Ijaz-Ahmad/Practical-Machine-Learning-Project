...
- The misclassified portion of data in respect of each model is almost invisible because of negligible in-sample and out-of-sample error rate.
...
- Out-of-sample error rate for each model is:
...
pred.treebag.caess <- predict(treebag.fit, pml.testing)
pred.rf.caess <- predict(rf.fit, pml.testing)
pred.gbm.caess <- predict(gbm.fit, pml.testing)

pred.comb.cases <- data.frame(pred.treebag = pred.treebag.caess,
